...
def process_song_data(spark, input_data, output_data):
    ...
    songs_table.write.partitionBy(['year','artist_id']).parquet("s3://udacity-s3datalake/Songs/song.parquet")
    ...
    artists_table.write.parquet("s3://udacity-s3datalake/Artists/artists.parquet")
...
def process_log_data(spark, input_data, output_data):
    ...
    users_table.write.parquet("s3://udacity-s3datalake/Users/users.parquet")
    ...
    time_table.write.partitionBy(['year','month']).parquet("s3://udacity-s3datalake/Time/time.parquet")
    ...
    songplays_table.write.partitionBy(['year','month']).parquet("s3://udacity-s3datalake/Songplays/songplays.parquet")
